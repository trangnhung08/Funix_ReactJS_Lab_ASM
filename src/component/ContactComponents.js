...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if (this.state.touched.firstname && firstname.length < 3)
            errors.firstname = "First Name shuold be >= 3 character";
        else if (this.state.touched.firstname && firstname.length > 10)
            errors.firstname = "First Name shuold be <= 10 character";

        if (this.state.touched.lastname && lastname.length < 3)
            errors.lastname = "Last Name shuold be >= 3 character";
        else if (this.state.touched.lastname && lastname.length > 10)
            errors.lastname = "Last Name shuold be <= 10 character";
                ...
                <div className='row row-content'>
                    ...
                    <div className='col-12 col-md-9'>
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                <Label htmlFor='fe' md={2}>Your Feedback</Label>
                                <Col md={10}>
